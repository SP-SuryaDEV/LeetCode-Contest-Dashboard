...
fig_text = f'LeetCode Weekly Contest 393 [14.04.2024] ({department if department != "All" else "All Depts."}) [{year if year != "All" else "All Years"}]'  # Dynamic title based on department filter  # Text to be underlined
